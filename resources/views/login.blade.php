...
<div class="nav">
    ...
    <div class="wrapper">
        ...
        <div class="form">
            <form class="fm" action="authenticate" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <h1 class="primary">login</h1>
                <p style="color: red;">{{app('request')->input('userexists')}}</p>
                <div class="inputs">
                    <input type="email" value="{{old('username')}}" name="email" placeholder="email"><br>
                    <span style="color: red;">{{ $errors->first('username') }}</span>
                    <input type="password" name="userpwd" placeholder="Password"><br>
                    <span style="color: red;">{{ $errors->first('userpwd') }}</span>
                    <p style="color: red;">{{app('request')->input('wrongpwd')}}</p>
